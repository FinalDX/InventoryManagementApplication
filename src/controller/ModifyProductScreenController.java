...
public class ModifyProductScreenController implements Initializable {
    ...
    {   
        try
        {
            ...
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Incorrect Values");
            alert.setContentText("Cannot modify product. \n"
